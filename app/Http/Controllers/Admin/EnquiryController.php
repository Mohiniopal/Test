...

{
    ...
    if ($request->filled('export')) {
        ...
        $columns = ['Full Name', 'Email', 'Mobile','City','Country','State','Message', 'Date'];
    ...
    return view('Admin.enquiry.view', ["enquiry_arr" => $data,
    ...
    if ($request->filled('export')) {
        ...
        $columns = ['Full Name', 'Email', 'Mobile','Designation','Qualification','Job Experience','City','Country', 'Date'];
        ...
        $callback = function () use ($data, $columns) {
            ...
            foreach ($data as $datas) {
                ...
                $row['Email'] = $datas->email;
                $row['Mobile'] = $datas->phone_number;
                $row['Designation'] = $datas->designation;
                $row['Qualification'] = $datas->qualification;
                $row['Job Experience'] = $datas->job_experience;
                $row['City'] = $datas->city;
                $row['Country'] = $datas->country;
                $row['Date'] = date('Y-m-d', strtotime($datas->created_at));
    ...
    return view('Admin.enquiry.view_apply_now', ["enquiry_arr" => $data,
        "start_date" => $request->input('start_date', ''),
          "end_date" => $request->input('end_date', ''),
           "search_text" => $request->input('search_text', ''),
        ]);
