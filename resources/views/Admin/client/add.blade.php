               ...
               <div class="card-body p-0">
                  ...
                  <div class="page-account-form">
                     ...
                     <div class="form-titel border-bottom p-3">
                        ...
                        <h5 class="mb-0 py-2">Add Clientele</h5>

                     </div>

                     <div class="p-3">

                        <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('createclient') }}">
                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input class="form-control" value="{{ old('client_title') }}" name="client_title" placeholder="Enter Client Title" type="text" required>
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input class="form-control" value="{{ old('orderby') }}" name="orderby" min="0" placeholder="Enter Alt Tag" type="number">
