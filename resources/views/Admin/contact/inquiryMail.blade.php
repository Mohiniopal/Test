 ...
 <tr align='center'>
<td colspan='2' style='border:none !important; padding-bottom:20px;padding-top:20px;'><img src="{{url('Admin/assets/img/af_logo.png')}}"  /></td>
 </tr>
 ...
 <tr>
<td align='left' bgColor='#f2f2f2' style='border:1px solid #ccc;padding:10px; font-family: Open Sans, sans-serif;font-size:16px;width:200px'><strong>Phone:</strong></td>
<td bgColor='#f2f2f2' style='border:1px solid #ccc;padding:10px; font-family: Open Sans, sans-serif;font-size:16px;'><?php echo $phone_number ?></td>
  ...
  <tr>
<td align='left' bgColor='#f2f2f2' style='border:1px solid #ccc;padding:10px; font-family: Open Sans, sans-serif;font-size:16px;width:200px'><strong>City:</strong></td>
<td bgColor='#f2f2f2' style='border:1px solid #ccc;padding:10px; font-family: Open Sans, sans-serif;font-size:16px;'><?php echo $city ?></td>
 </tr>


  <tr>
<td align='left' bgColor='#f2f2f2' style='border:1px solid #ccc;padding:10px; font-family: Open Sans, sans-serif;font-size:16px;width:200px'><strong>State:</strong></td>
<td bgColor='#f2f2f2' style='border:1px solid #ccc;padding:10px; font-family: Open Sans, sans-serif;font-size:16px;'><?php echo $state ?></td>
 </tr>
