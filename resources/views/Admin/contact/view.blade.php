...
<div class="row">
    <form action="{{ route('contactus') }}" method="GET" id="filter-form" class="w-100">
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                <button type="submit" class="btn btn-dark text-white">Filter Data</button>
            </div>
            <div class="col-md-4 mb-3">
                <a href="{{ route('contactus') }}" class="btn btn-dark text-white">Reset</a>
            </div>
            <div class="col-md-4 mb-3">
                  ...
                  <div class="table-responsive">
                     ...
                     <table id="table" class="table display responsive nowrap table-light table-bordered">
                        ...
                        @foreach($cont_arr as $key => $data)
                           ...
                           <p class="text-danger mt-2" style="padding-left:450px;">No Contact Us Available</p>
