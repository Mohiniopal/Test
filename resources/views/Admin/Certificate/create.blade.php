               ...
               <div class="card-body p-0">
                  ...
                  <div class="page-account-form">
                     <div class="form-titel border-bottom p-3">
                        <h5 class="mb-0 py-2">Add Certificate</h5>
                     </div>
                     <div class="p-3">
                        <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('createcertificate') }}">
                           @csrf
                           <div class="row">
                              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                 <div class="form-group">
                                    <label>Title<span style="color:#ff0000">*</span></label>
                                    <input class="form-control" value="{{ old('name') }}" name="name" placeholder="Enter Title" type="text" required>
                                    @error('name')
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                   <label>OrderBy</label>
                                   <input class="form-control" value="{{ old('orderby') }}" name="orderby" min="0" type="number">
                                </div>
                             </div>
