...
<head>
    <title>Mentor - Reset Password</title>
    <meta charset="utf-8" />
                            ...
                            <div class="col-sm-6 col-lg-5 col-xxl-3  align-self-center order-2 order-sm-1">
                                <div class="d-flex align-items-center h-100-vh">
                                    <div class="login p-50">
                                        ...
                                        <form method="POST" action="{{url('/admin/password_store')}}" enctype="multipart/form-data" class="needs-validation" class="mt-3 mt-sm-5">
                                        @csrf
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label class="control-label">Password*</label>
                                                        <input type="password" class="form-control" placeholder="Password" name="reset_pass"/>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" class="form-control" placeholder="Re-write Password" name="confirm_password"/>
