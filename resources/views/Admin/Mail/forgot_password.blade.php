...
<head>
    <title>Mentor - Forgot Password</title>
    <meta charset="utf-8" />
                            ...
                            <div class="col-sm-6 col-lg-5 col-xxl-3  align-self-center order-2 order-sm-1">
                                <div class="d-flex align-items-center h-100-vh">
                                    <div class="login p-50">
                                        ...
                                        <p>Enter your email to get a password reset otp</p>
                                        <form method="POST" action="{{url('/admin/forgot_password')}}" enctype="multipart/form-data" class="needs-validation" class="mt-3 mt-sm-5">
                                        @csrf
                                            <div class="row">
                                                <div class="col-12">
