               ...
               <div class="card-body p-0">
                  <div class="page-account-form">
                     <div class="form-titel border-bottom p-3">
                        <h5 class="mb-0 py-2">Update Image</h5>
                     </div>
                     <div class="p-3">
                        <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('updateimage', $Client->id) }}">
                           @csrf
                           <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                 <div class="form-group">
                                    <label>Title<span style="color:#ff0000">*</span></label>
                                    <input class="form-control" value="{{ $Client->title }}" name="title" placeholder="Enter Title" type="text" required>
                                    @error('title')
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                 <div class="form-group">
                                    ...
                                    @if($Client->image)
                                    <img src="{{ URL('public/upload/image') }}/{{ $Client->image }}" alt="" height="100px" width="100px">
                                    @endif
                                    @error('image')
                                    <p class="text-danger"><small>{{ $message }}</small></p>
                                    @enderror
