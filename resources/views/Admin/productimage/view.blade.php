...
<div class="app-main" id="main">
   ...
   <div class="container-fluid">
      ...
      <div class="row mb-2">
             ...
             <form action="{{ route('savegallerproductimage',$product_id) }}" class="dropzone" id="my-awesome-dropzone">
             @csrf
            </form>
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 ...
                                 <div class="mt-2">
                                    <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('tag_updateproductimage', $data->id)}}">
                                       @csrf
                                       <div class="row">
                              ...
                              <td class="text-left" style="width:25px">
                                 <div class="actions">
                                    ...
                                    <a  href="javascript:void(0)" data-delete_url="{{url('productimage/delete/'.$data->id)}}"   class="btnDelete btn btn-sm bg-danger-light">
