...
(function(window, document, $, undefined){
    ...
    $(function(){
        ...
        // test code
        var banner_desc = jQuery(".banner_desc");
        if (banner_desc.length > 0) {
        ...
        var banner_sub_heading = jQuery(".banner_sub_heading");
        if (banner_sub_heading.length > 0) {
          $('#banner_sub_heading').summernote({
              tabsize: 2,
              height: 250
          });
        }

        var banner_edit_desc = jQuery(".banner_edit_desc");
        if (banner_edit_desc.length > 0) {
          $('#banner_edit_desc').summernote({
              tabsize: 2,
              height: 250
          });
        }

        var banner_edit_sub_heading = jQuery(".banner_edit_sub_heading");
        if (banner_edit_sub_heading.length > 0) {
          $('#banner_edit_sub_heading').summernote({
              tabsize: 2,
              height: 250
          });
        }

        var cms_rubric = jQuery(".cms_rubric");
        if (cms_rubric.length > 0) {
          $('#cms_rubric').summernote({
              tabsize: 2,
              height: 250
          });
        }

        var cms_shrt_desc = jQuery(".cms_shrt_desc");
        if (cms_shrt_desc.length > 0) {
          $('#cms_shrt_desc').summernote({
              tabsize: 2,
              height: 250
          });
        }

        var cms_full_desc = jQuery(".cms_full_desc");
        if (cms_full_desc.length > 0) {
          $('#cms_full_desc').summernote({
              tabsize: 2,
              height: 250
          });
        }

        var cate_rubric = jQuery(".cate_rubric");
        if (cate_rubric.length > 0) {
          $('#cate_rubric').summernote({
              tabsize: 2,
              height: 250
          });
        }

        var prod_rubric = jQuery(".prod_rubric");
        if (prod_rubric.length > 0) {
          $('#prod_rubric').summernote({
              tabsize: 2,
              height: 250
          });
        }

        var prod_desc = jQuery(".prod_desc");
        ...
        var prod_prop = jQuery(".prod_prop");
        if (prod_prop.length > 0) {
          $('#prod_prop').summernote({
              tabsize: 2,
              height: 250
          });
        }

        var prod_sol = jQuery(".prod_sol");
        if (prod_sol.length > 0) {
          $('#prod_sol').summernote({
              tabsize: 2,
              height: 250
          });
        ...
        var prod_spec = jQuery(".prod_spec");
        if (prod_spec.length > 0) {
          $('#prod_spec').summernote({
              tabsize: 2,
              height: 250
          });
        }
